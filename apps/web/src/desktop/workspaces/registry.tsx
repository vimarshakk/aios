...
const COMPONENT_LOADERS: Record<string, () => Promise<{ default: ComponentType }>> = {
  "mission-control": () => import("./MissionControl").then(m => ({ default: m.MissionControl })),
  "conversation": () => import("./Conversation").then(m => ({ default: m.ConversationWorkspace as ComponentType })),
  "goals": () => import("./Goals").then(m => ({ default: m.GoalsWorkspace as ComponentType })),
  "projects": () => import("./Projects").then(m => ({ default: m.ProjectsWorkspace as ComponentType })),
  "memory": () => import("./Memory").then(m => ({ default: m.MemoryWorkspace as ComponentType })),
  "memory-explorer": () => import("./MemoryExplorer").then(m => ({ default: m.MemoryExplorerWorkspace as ComponentType })),
  "agents": () => import("./Agents").then(m => ({ default: m.AgentsWorkspace as ComponentType })),
  "skills": () => import("./Skills").then(m => ({ default: m.SkillsWorkspace as ComponentType })),
  "logs": () => import("./Logs").then(m => ({ default: m.LogsWorkspace as ComponentType })),
  "settings": () => import("./Settings").then(m => ({ default: m.SettingsWorkspace as ComponentType })),
